...
# Usage: ./verify-output-files.sh <year> [output_dir] [max_schedules] [source] [skip_schedules]

YEAR="${1:?Usage: $0 <year> [output_dir] [max_schedules] [source] [skip_schedules]}"
OUTPUT_DIR="${2:-out}"
MAX_SCHEDULES="${3:-}"
SOURCE="${4:-mcla}"
SKIP_SCHEDULES="${5:-}"
