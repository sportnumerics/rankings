...
def add_parsers(parsers):
  ...
  scrape_parser.add_argument('--year', help='year to fetch (defaults to current year)')
  scrape_parser.add_argument('--out-dir', default='out', help='output directory')
  ...
  schedule_parser = scrape_subparsers.add_parser('schedules', help='scrape team schedules')
  schedule_parser.add_argument('--team-list-file', help='File to read team list from (will scrape them by default)')
